...
Use `assets/report.key` as the export template. Keep it versioned beside this skill in connected GitHub. Because GitHub storage does not prove a live consumer can use the Repository Asset, stop only the export operation unless a Live Capability for consuming it is verified.
